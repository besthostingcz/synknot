...
class SampleMySQLiDNSRecordsAdapter extends AbstractDataAdapter{
	public function getData() {
		...
		$result = $connection->query('SELECT CONCAT(d.name, ".", d.tld) ' .
			'AS domainName, d.dnssec, r.name, r.type, r.content, r.ttl, r.priority ' .
